...
<script type="text/javascript">
  ...
  function addMedicineMaster(){
	  
	  var medName=document.getElementById("medicineName").value;
	  var comment=document.getElementById("comment").value;
	  alert(comment);
	  
	  document.location.href="/info.mourya.goiot/updateMedicineMaster/"+medName+"/"+comment;
...
<div class="w3-container w3-top w3-theme-dark w3-large w3-padding" style="z-index:4">
  ...
  <span class="w3-right"><img src="img/headlogo.png" style="height:30px;"></span>
</div>
<!-- Sidenav/menu -->
...
<div id="maincontent" class="w3-main" style="margin-top:43px;">
  <div class="w3-container">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-medkit"></i>ADD USER ${failMsg}</b></h5>
    </header>
    <form method="POST" action="/info.mourya.goiot/addNewUserToDb" class="w3-container w3-card-4">
      <div class="w3-row-padding">
        ...
        <div class="w3-group">      
          <input class="w3-input" type="text" name="gender" required>
        ...
        <div class="w3-group">      
          ...
          <label class="w3-label w3-validate" >Mobile</label>
        </div>
      </div>
      
      <div class="w3-group">      
          
          <input class="w3-hover-text-blue" type="submit" value="ADD USER">
