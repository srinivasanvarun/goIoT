...
<div id="maincontent" class="w3-main" style="margin-top:43px;">
  <div class="w3-container">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-medkit"></i>Add Medicine ${failMsg}</b></h5>
    </header>
      
    <form method="POST" action="/info.mourya.goiot/addPrescriptionDetails/${patientId}/${doctorId}" class="w3-container w3-card-4">
      <div class="w3-row-padding">
        <div id="med">
            <input type="hidden" id="patientUserId" value="${patientId}" >   
          ...
          <div class="w3-half w3-group">   
            <div> 
                ...
                <select name="medicineId">
                    ...
                    <option value="${masterMedicineObject.medicineMasterId}">${masterMedicineObject.medicinename}</option>
                    </c:forEach>
                </select>
          ...
          <div class="w3-half w3-row-padding">      
            ...
            <div class="w3-quarter w3-group">      
              ...
              <label class="w3-label w3-validate">Evening</label>
              <select name="evening">
                    <option value="0">0</option>
                    <option value="1">1</option>
            ...
            <div class="w3-quarter w3-group">      
              ...
              <label class="w3-label w3-validate">Duration</label>
              <select name="prescription_dur">
        ...
        <div class="w3-group w3-row-padding">      
          <input class="w3-hover-text-blue" type="submit" value="Save Prescription">
