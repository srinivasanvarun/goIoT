...
<script type="text/javascript">
  ...
  function functionEditUserMed(patientUserId) {
	    var medicineId=0;
	    var doctorUserId=document.getElementById("doctorUserId").value;
		document.location.href="/info.mourya.goiot/getPrescriptionDetails/"+patientUserId+"/"+doctorUserId+"/"+0;
	}
  
  function functionAddMedicineMaster() {
	    var doctorUserId=document.getElementById("doctorUserId").value;
		document.location.href="/info.mourya.goiot/addMedicineMaster";
	}
</script>

<body>
<!-- Top container -->
<input type="hidden" name="loginObject" value="${loginObject}">
<input type="hidden" id="doctorUserId" value = "${docDetailsObject.userId}" >
...
<div id="mySidenav" style="max-width:100px;" class="hidden">
	<nav class="w3-sidenav w3-light-grey"><br>
	  <div class="w3-container w3-row">
	    ...
	    <div class="w3-col s8">
	      <span>Hello, <strong>${docDetailsObject.doctorLName}</strong></span><br>
	  ...
	  <div class="nav">
	    ...
	    <button id="a3" class="navbuttons" onclick="toggleVisibility('d3')"><i class="fa fa-medkit fa-fw"></i>&nbsp; Medicines</button>
	    <button id="a4" class="navbuttons" onclick="toggleVisibility('d4')"><i class="fa fa-cog fa-fw"></i>&nbsp; Settings</button>
...
<div id="maincontent" class="w3-main" style="margin-top:43px;">
    ...
    <div class="w3-row-padding w3-margin-bottom">
      <div class="w3-third">
        <div class="w3-container w3-teal w3-padding-16">
          ...
          <div class="w3-right">
            <h3>${docDetailsObject.statDetailsObject.docCount}</h3>
          </div>
      ...
      <div class="w3-third">
        <div class="w3-container w3-red w3-padding-16">
          ...
          <div class="w3-right">
            <h3>${docDetailsObject.statDetailsObject.patientCount}</h3>
          </div>
          <div class="w3-clear"></div>
          <h4>Patients</h4>
        </div>
      ...
      <div class="w3-third">
        <div class="w3-container w3-blue w3-padding-16">
          ...
          <div class="w3-right">
            <h3>${docDetailsObject.statDetailsObject.medCount}</h3>
          </div>
          <div class="w3-clear"></div>
          <h4>Medicines</h4>
        </div>
  ...
  <div id="d2" class="hidden w3-container">
    ...
    <div class="w3-container">
      ...
      <table class="w3-table w3-bordered w3-border w3-hoverable w3-white">
        ...
        <c:forEach items="${docDetailsObject.patientDetailsObjectList}" var="patientDetailsObject"> 
         <tr>
         ...
         <td><button class="w3-btn" onclick="functionEditUserMed('${patientDetailsObject.userId}')" value="">Modify Prescription &nbsp;<i class="fa fa-arrow-right"></i></button></td>
        </tr>
        </c:forEach>
      </table><br>
  ...
  <div id="d3" class="hidden w3-container">
    ...
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
      ...
      <c:forEach items="${masterMedicineObjectList}" var="masterMedicineObject"> 
      <tr>
        <td>${masterMedicineObject.medicinename}</td>
           <td>${masterMedicineObject.comments}</td>
      </tr>
      </c:forEach>
    </table><br>
    <button class="w3-btn" onclick="functionAddMedicineMaster()">Add Medicines &nbsp;<i class="fa fa-arrow-right"></i></button>
  </div>
  <div id="d4" class="hidden w3-container">
    ...
    <form method="" action="" class="w3-container w3-card-4">
      <div class="w3-row-padding">
        ...
        <div class="w3-group">      
          <input class="w3-hover-text-blue" type="button" onclick=" " value="Change Password" required>
        </div>
      </div>
    </form>
  </div>
    ...
    <form method=" " action="" class="w3-container w3-card-4">
     ...
     <c:forEach items="${docDetailsObject.patientDetailsObjectList}" var="patientDetailsObject">
        ...
        <div id="med">
          ...
          <div class="w3-half w3-group">      
            <input class="w3-input" type="text" value="${medDetailsObject.pillName}" required>
            <label class="w3-label w3-validate">Medicine Name</label>
          </div>
          <div class="w3-half w3-row-padding">      
            <div class="w3-third w3-group">      
              <input class="w3-input" type="text" value="${medDetailsObject.morning}">
              <label class="w3-label w3-validate">Morning</label>
            </div>
            <div class="w3-third w3-group">      
              <input class="w3-input" type="text" value="${medDetailsObject.afternoon}">
              <label class="w3-label w3-validate">Afternoon</label>
            </div>
            <div class="w3-third w3-group">      
              <input class="w3-input" type="text" value="${medDetailsObject.evening}">
        ...
        <div class="w3-third w3-group">      
            <input class="w3-hover-text-blue" type="button" value="Add">     
            <input class="w3-hover-text-blue" type="button" value="Delete"> 
          </div>
      
        <div class="w3-group w3-row-padding">      
          <input class="w3-hover-text-blue" type="button" value="Save Prescription">
  ...
  <!-- Footer -->
  <footer class="w3-container w3-bottom w3-theme-dark" style="50px;">
