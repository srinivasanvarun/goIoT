...
<div id="maincontent" class="w3-main" style="margin-top:43px;">
  <div class="w3-container">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-medkit"></i> Add Medicine ${successMsg}</b></h5>
    </header>
    <form method="" action="/info.mourya.goiot/" class="w3-container w3-card-4">
      <div class="w3-row-padding">
        <div class="w3-group">      
          <input class="w3-input" type="text" id="medicineName" required>
          <label class="w3-label w3-validate" >Medicine Name</label>
        </div>
        <div class="w3-group">      
          <input class="w3-input" type="text" id="comment">
          <label class="w3-label w3-validate" >Comment</label>
        </div>
        <div class="w3-group">      
          <input class="w3-hover-text-blue" type="button" value="Add Medicine" onclick="addMedicineMaster()">
